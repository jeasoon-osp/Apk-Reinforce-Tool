...
public class PatternOptionBuilder
{
    ...
    /**
     * Returns the {@link org.jeson.commons.cli.Options} instance represented by <code>pattern</code>.
     *
     * @param pattern the pattern string
     * @return The {@link org.jeson.commons.cli.Options} instance
     */
    public static org.jeson.commons.cli.Options parsePattern(String pattern)
    {
        char opt = ' ';
        boolean required = false;
        Class<?> type = null;

        org.jeson.commons.cli.Options options = new org.jeson.commons.cli.Options();
